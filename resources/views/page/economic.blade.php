...
@section('content')
    ...
    <div class="card items text-center">
        <img height="170" src="https://pharmvestnik.ru/apps/fv/assets/cache/files/content/news/408/40883/front-jpg/front-z-400.jpg?time=1538995042" class="card-img-top" alt="stocks news">
        <div class="card-body">
